...
VALUES ('Ginevra', 'AA000AA', 12000, 1, 'Bianca', true, 'Tesla model 3', 'Staglieno'),
       ...
       ('Caterina', 'AA000AC', 12000, 0, 'Nera', true, 'Tesla model 3', 'Staglieno'),
       ('Valeria', 'AA000AD', 12000, 0, 'Rossa', true, 'Tesla model 3', 'Staglieno'),
       ...
       ('Olivia', 'AA000AJ', 12000, 2, 'Rossa', true, 'Fiat 500', 'Piazza Dante'),
       ('Claudia', 'AA000AK', 12000, 1, 'Azzurra', true, 'Fiat 500', 'Piazza Dante'),
       ('Ivana', 'AA000AL', 12000, 0, 'Gialla', true, 'Fiat seicento', 'Piazza Dante'),
       ...
       ('Camilla', 'AA000AO', 12000, 1, 'Blu', true, 'Fiat Tipo', 'Fiumara'),
